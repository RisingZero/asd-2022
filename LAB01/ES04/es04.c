/* 
    LAB1 ES04 RAINERI ANDREA ANGELO S280848
...
void eseguiComando(enum comando_e comando, corsa_t **corse_ord[], int numCorse);
...
int main(int argc, char const *argv[]) {
    ...
    do {
        ...
        if (comando != r_fine)
            eseguiComando(comando, corse_ord, numCorse);
